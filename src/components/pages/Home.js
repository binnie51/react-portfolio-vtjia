...
export default function Home() {
  const greetingsArray = ["Welcome", "Selamat datang", "ようこそ", "欢迎"];
  ...
  return (
    <div>
      <header className="container-fluid">
        <div
          className="relative bg-cover bg-no-repeat bg-center w-full md:max-xl:flex"
          style={{
        ...
        >
          <div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
            ...
            >
              <h3 className="font-medium animate-[slide_4s_ease-in-out_infinite]">
                {greet}
              </h3>
              <h1 className="font-bold">Vincent Tjia</h1>
              <div
                className="bg-amber-600"
                style={{ height: 2.5, width: "30%" }}
              ></div>
              <h2>
              ...
              <div className="font-medium mt-8 flex flex-wrap justify-around gap-4 text-center">
                <a
                  className="myResumeBtn block w-full rounded px-12 py-3 bg-amber-600 hover:bg-gray-900 sm:w-auto duration-150 ease-in-out"
                  href={resume}
                  target="_blank"
                  rel="noreferrer"
                >
